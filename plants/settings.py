...
class Base(Configuration):
    ...
    SECRET_KEY = values.Value('ptnMFVIEecxWVBXvliPXlhyHYpTxNyvgbgDOqNgWQhIQGcrOCJ')
    ...
    PLANTS_APPS = []
    INSTALLED_APPS = DJANGO_APPS + THIRD_PARTY_APPS + PLANTS_APPS
    ...
    MIDDLEWARE = [
        ...
        "plants.middleware.TimezoneMiddleware",
    ...
    DATABASES = values.DatabaseURLValue("postgresql://plants_user:plants_pass@127.0.0.1:5432/plants_db")
...
class Testing(Development):
    ...
    DATABASES = values.DatabaseURLValue( # This is about defaulting to running vs docker db if you don't specify something else
        "postgresql://plants_user:plants_pass@127.0.0.1:5433/plants_db")
